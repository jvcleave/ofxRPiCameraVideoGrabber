...
public:
    ...
    void update()
    {
        ...
        if (doChangeMeteringMode) 
        {
            ...
            videoGrabber->cameraSettings.setMeteringMode(meteringModes[currentMeteringMode]);
        }
        if(doShutterSpeed)
        {
            int currentShutterSpeed = videoGrabber->cameraSettings.getShutterSpeed();
        ...
        if(doAperture)
        {
            ...
            videoGrabber->cameraSettings.setAperture(currentAperture);
        }
        if(doISO)
        {
            ...
            videoGrabber->cameraSettings.setISO(currentISO);
        }
    ...
    void draw()
    {
        ...
        info << "Press x to toggle Shutter Speed increase: " << videoGrabber->cameraSettings.getShutterSpeed() << "\n";
